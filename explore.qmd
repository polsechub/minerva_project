...
Using a simple stata command to explore how monthly stringency index explains cumulative count of vessels in monthly grid (following command), produces figure shown below. This is for each grid-cell: on average, when stringency was increased from 0 to 50, there were 10 less vessels in a grid-cells in the Gulf of Guinea. 
